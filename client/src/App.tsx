...
function Router() {
  return (
    <div className="min-h-screen relative">
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-gradient-to-t from-slate-900/80 to-slate-900/40 backdrop-blur-sm py-12 border-t border-slate-700/50 mt-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                A passionate developer creating innovative digital experiences with modern technologies and creative solutions.
              </p>
            </div>
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/articles" className="text-slate-400 hover:text-blue-400 transition-colors">Articles</a></li>
          ...
          <div className="border-t border-slate-700/50 pt-6 text-center">
            <p className="text-slate-400 text-sm">
              © 2024 Portfolio. Built with ❤️ using React & TypeScript
            </p>
          </div>
        </div>
      </footer>
